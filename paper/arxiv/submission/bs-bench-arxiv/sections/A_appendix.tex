...
\subsection{Instruction Violation Under the Honesty Mandate}

Game \texttt{exp3\_m0\_g0\_1774999669636}, Turn~2, Qwen:
...
This is a compact example of the honesty-mandate result. The model explicitly recognizes the instruction, recognizes that it lacks the required card, and still chooses a minimal bluff because that locally dominates doing nothing.

\subsection{Combinatorial Lie Detection}

Game \texttt{exp3\_m0\_g1\_1774896843970}, Turn~2, Nemotron challenge:
